      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <FormField name="phone" control={form.control} render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input type="tel" placeholder="07xxxxxxxx or +2547xxxxxxxx" {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )} />

        <FormField name="residence" control={form.control} render={({ field }) => (
          <FormItem>
        ...
        <FormField name="purpose" control={form.control} render={({ field }) => (
          <FormItem>
            ...
            <Select onValueChange={field.onChange} defaultValue={field.value}>
              ...
              <SelectContent>
                <SelectItem value="Preparing for tertiary studies">Preparing for tertiary studies</SelectItem>
                <SelectItem value="Starting a cyber café or ICT business">Starting a cyber café or ICT business</SelectItem>
                <SelectItem value="Gaining essential digital skills for work or daily life">Gaining essential digital skills for work or daily life</SelectItem>
              </SelectContent>
            </Select>
            <FormMessage />
          </FormItem>
